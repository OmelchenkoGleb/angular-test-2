...
import com.example.demo.CrudRepository.*;
...
public class DBDao {
    ...
    public List<all_data> getSemestr(double semestr){return crudAllData.findAllBySemestrOrderByTeachers(semestr);}
    ...
    public List<Teachers> getTeachers(){return crudTeachers.findAll();}
