...
public interface CrudAllData extends CrudRepository<all_data,Long> {
    List<all_data> findAllBySemestr(double semestr);
    List<all_data> findAllByTeachersAndSemestr(Teachers teachers, double semestr);
    List<all_data> findAllBySemestrOrderByTeachers(double semestr);
